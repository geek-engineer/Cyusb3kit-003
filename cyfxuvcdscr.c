...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
...
#else
        0x1E,0x01,                      /* Length of this descriptor and all sub descriptors 3 frame des*/
#endif
        0x02,                           /* Number of interfaces */
#endif
        0x01,                           /* Configuration number */
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        /* Class specific Uncompressed VS frame descriptor 1: 640*480 30fps*/
        0x1E,                           /* Descriptor size */
        0x24,                           /* Descriptor type*/
        0x05,                           /* Subtype: uncompressed frame I/F */
        0x01,                           /* Frame Descriptor Index */
        ...
        /* Class specific Uncompressed VS frame descriptor 2: 1280*720 30fps*/
		0x1E,                           /* Descriptor size */
		0x24,                           /* Descriptor type*/
		0x05,                           /* Subtype: uncompressed frame I/F */
        ...
        /* Class specific Uncompressed VS frame descriptor 3:1920*1080 24fps*/
        ...
        0xC2, 0xA6, 0x05, 0x00,         /* frame interval (in 100ns units): (1/27)x10^7 */
        0x9A, 0x5B, 0x06, 0x00,         /* frame interval (in 100ns units): (1/24)x10^7 */
